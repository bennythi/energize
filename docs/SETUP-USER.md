...
| 3   | Wix-Inspect: echte Brand-Tokens extrahieren    | 30 min                      | Authentischer Brand-Look      | [wix-inspect.md](./wix-inspect.md)       |
...
- Wix-Inspect-Werte extrahieren (30 min) — Tokens werden authentisch.
...
- DNS-Records ändern.
- Domain umziehen.
- Brand-Akzentfarbe „raten" — wir starten monochrom Schwarz/Weiß.
